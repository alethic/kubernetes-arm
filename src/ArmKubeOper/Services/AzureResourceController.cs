...
namespace ArmKubeOper.Services
{
    ...
    /// <summary>
    /// Manages the lifecycle of an <see cref="AzureResource"/>.
    /// </summary>
    ...
    public class AzureResourceController : IResourceController<AzureResource>
    {

        readonly AzureService azure;
        readonly IFinalizerManager<AzureResource> finalizer;
        ...
        public AzureResourceController(AzureService azure, IFinalizerManager<AzureResource> finalizer, ILogger logger)
        {
        ...
        /// <summary>
        /// Reconciles the state of the entity with it's external resource.
        /// </summary>
        /// <param name="entity"></param>
        /// <returns></returns>
        public async Task<ResourceControllerResult> ReconcileAsync(AzureResource entity)
        {
